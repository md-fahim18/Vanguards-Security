...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const subject = encodeURIComponent(`যোগাযোগ বার্তা - ${formData.name}`)
      const body = encodeURIComponent(`নাম: ${formData.name}\nইমেইল: ${formData.email}\n\nবার্তা:\n${formData.message}`)
      window.location.href = `mailto:fahimzarif678@gmail.com?subject=${subject}&body=${body}`

      alert("ধন্যবাদ! আপনার ইমেইল ক্লায়েন্ট খোলা হয়েছে।")
